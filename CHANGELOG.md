...
## Added
- New instruction data `SetForeignDepositData` 
...
## Fixed
- Added `user_metadata` and `rentsysvar` in `kamino_change_position`

## [v2.64]

## Removed
- `refferall user state` from `init_obligaion`

## Added
- `withdraw_all/repay_all` flags in `KaminoChangePositionLog`


## [v2.63]

## Added 
- `KaminoReserveIsMissing` error msg

## [v2.62]

## Added
- `InvalidOperationForEmptyObligation` error msg

## [v2.61]

## Fixed
- Reduced `MIN_ACCOUNTS` for `kamino_init_obligation` to 11.
